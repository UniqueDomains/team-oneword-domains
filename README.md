...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-7%2C872%20rows-8250df">
...
> **Important:** this repository is a **public 7,872-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,622,055 domains** on the canonical page below.

**Public extract:** 7,872 rows · **Live catalog:** 5,622,055 domains
...
- `team.csv` — public CSV extract (7,872 rows)
- `team.json` — public JSON extract (7,872 rows)
...
| handle.team        | available | $7.99     | —             | 76             | 21     | 6      | name.com          |
...
| ----------------------- | ------------------------------------------------ |
| 7,872-row public sample | 5,622,055 live domains                           |
...
> Unique Domains. *Available .TEAM One-Word Domains*. Version 2026-04-10. Public GitHub extract for the exact Unique Domains search represented by this repository.
