# Available .TEAM One-Word Domains (5,622,055)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-7%2C875%20rows-8250df">
...
> **Important:** this repository is a **public 7,875-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,622,055 domains** on the canonical page below.

**Public extract:** 7,875 rows · **Live catalog:** 5,622,055 domains
...
<p align="center">
  ...
  <a href="https://unique.domains/domains/tld/team?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_team_oneword_domains&utm_content=top_create_radar"><b>🔔 Create Radar</b></a> ·
  <a href="https://unique.domains/domains/tld/team?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_team_oneword_domains&utm_content=top_start_project"><b>🚀 Start a Project</b></a> ·
  <b>⬇️ Download sample</b>: <a href="./team.csv">CSV</a> / <a href="./team.json">JSON</a>
</p>

<p align="center">
  <a href="https://unique.domains/technology?utm_source=github&utm_medium=referral&utm_campaign=repo_team_oneword_domains&utm_content=top_methodology">Methodology</a> ·
  <a href="https://unique.domains/api?utm_source=github&utm_medium=referral&utm_campaign=repo_team_oneword_domains&utm_content=top_api_docs">API docs</a>
</p>
...
- **Investors:** [Create a Radar from this exact .TEAM search](https://unique.domains/domains/tld/team?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_team_oneword_domains&utm_content=top_create_radar)
- **Founders:** [Start a Project from this exact .TEAM search](https://unique.domains/domains/tld/team?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_team_oneword_domains&utm_content=top_start_project)
- **Researchers / builders:** [Download CSV](./team.csv) or [Download JSON](./team.json)
...
- `team.csv` — public CSV extract (7,875 rows)
- `team.json` — public JSON extract (7,875 rows)
...
| ----------------------- | ------------------------------------------------ |
| 7,875-row public sample | 5,622,055 live domains                           |
...
| ------------------ | --------- | --------- | ------------- | -------------- | ------ | ------ | ----------------- |
| lovely.team        | available | $7.99     | $48.99        | 72             | 33     | 6      | name.com          |
| anywhere.team      | resell    | $7.99     | —             | 82             | 27     | 8      | Spaceship, Inc.   |
| doctor.team        | premium   | $130      | $260          | 84             | 36     | 6      | namecheap         |
| dirty.team         | available | $7.99     | $48.99        | 92             | 26     | 5      | name.com          |
| providence.team    | resell    | $7.99     | —             | 82             | 23     | 10     | Spaceship, Inc.   |
...
| handle.team        | available | $7.99     | —             | 76             | 22     | 6      | name.com          |
...
| accessible.team    | available | $7.99     | $48.99        | 78             | 21     | 10     | name.com          |
...
> Unique Domains. *Available .TEAM One-Word Domains*. Version 2026-04-09. Public GitHub extract for the exact Unique Domains search represented by this repository.
